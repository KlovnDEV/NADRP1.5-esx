Locales['en'] = {
    ...
    -- Ban strings
    ['checking'] = 'FFRP | You are currently being checked...',
    ['user_ban_reason'] = 'FFRP | You have been banned from this server ( 𝗨𝘀𝗲𝗿𝗻𝗮𝗺𝗲: %s )',
    ['user_kick_reason'] = 'FFRP | You have been kicked ( 𝗥𝗲𝗮𝘀𝗼𝗻: %s )',
    ['banlist_ban_reason'] = 'Player has tried to trigger \'%s\' event',
    ['banlist_not_loaded_kick_player'] = 'FFRP | Our bans hasn\'t loaded, you\'ll have to wait a couple of seconds. Try again later!',
    ['ip_not_found'] = 'FFRP | We couldn\'t find your IP',
    ['ip_blocked'] = 'FFRP | You have a VPN active, disable it to join the server | Wrong? Contact the server owners',
    ['new_identifiers_found'] = '%s, new identifier(s) found - original ban %s',
    ['failed_to_load_banlist'] = '[FFRP] Failed to load Banlist!',
    ['failed_to_load_tokenlist'] = '[FFRP] Failed to load Tokenlist!',
    ['failed_to_load_ips'] = '[FFRP] Failed to load IPs!',
    ['failed_to_load_check'] = '[FFRP] Please check this error soon, Bans *will not* work!',
    ...
    -- Discord
    ['discord_title'] = '[FFRP] Has banned a player',
