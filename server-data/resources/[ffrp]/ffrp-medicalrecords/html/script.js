$(document).ready(function(){
   ...
   $(document).on("click", "#close", function (param) { 
    ...
    function close() { 
        $.post('http://ffrp-medicalrecords/close', JSON.stringify({display: false}));
    ...
    $(document).on("click", "#search-button", function (e) {
        ...
        if (input != "") {
            $.post('http://ffrp-medicalrecords/search', JSON.stringify({input: input}));
        } else {
    ...
    $(document).on("click", "#patient-submit", function (e) {
        ...
        if (patient_name != "" || patient_data != "") {
            document.getElementById("patient-name").value = ""
            document.getElementById("patient-data").value = ""
            $.post('http://ffrp-medicalrecords/create', JSON.stringify({name: patient_name, text: patient_data}));
