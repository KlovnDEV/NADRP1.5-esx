...
AddEventHandler('tac:playerLoaded', function(source, user)
	local src = source
	local xPlayer = ESX.GetPlayerFromId(src)
	while xPlayer == nil do Citizen.Wait(100) end
...
RegisterNetEvent('tac_license:revokeLicense')
AddEventHandler('tac_license:revokeLicense', function(target, type, cb)
...
ESX.RegisterServerCallback('tac_license:getLicense', function(source, cb, type)
	GetLicense(type, cb)
end)

ESX.RegisterServerCallback('tac_license:getLicenses', function(source, cb, target)
	GetLicenses(target, cb)
end)

ESX.RegisterServerCallback('tac_license:checkLicense', function(source, cb, target, type)
	CheckLicense(target, type, cb)
end)

ESX.RegisterServerCallback('tac_license:getLicensesList', function(source, cb)
	GetLicensesList(cb)
end)
