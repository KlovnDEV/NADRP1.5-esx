$(function () {
    ...
    window.addEventListener('message', function (event) {
        if (event.data.type == "updateStatusHud") {
            ...
            $("#varSetHunger").find(".progressBar").attr("style", "width: "+event.data.varSetHunger + "%;")
            $("#varSetThirst").find(".progressBar").attr("style", "width: "+event.data.varSetThirst + "%;")
