...
--local NearNPC = exports["ffrp-ped"]:GetClosestNPC()
--local handcuffed = exports["ffrp-ped"]:isPed("handcuffed")
--local NearNPC = exports["ffrp-ped"]:GetRandomNPC()
...
-- local countpolice = exports["ffrp-ped"]:isPed("femaleclothes")
...
AddEventHandler('ffrp-policejob:HandCuffedState', function(handCuffed,handCuffedWalking)
...
AddEventHandler('ffrp-banking:updateBalance', function(amount)
...
RegisterNetEvent('ffrp-ped:UpdateCash')
AddEventHandler('ffrp-ped:UpdateCash', function(newCash)
  cash = newCash
end)
