...
Citizen.CreateThread(function()
    while true do
        ...
        if NetworkIsSessionStarted() then
			TriggerServerEvent('ffrp-admin:AddPlayer')
		   	TriggerServerEvent("ffrp-scoreboard:AddPlayer")
...
AddEventHandler('kashactersC:SetupCharacters', function()
	...
	TriggerServerEvent('ffrp-login:GetSpawnPos')
end)
...
AddEventHandler('kashactersC:SpawnCharacter', function(spawn, isnew)
	...
	if isnew then
		...
		IsChoosing = false
		TriggerEvent('ffrp-login:SetStates')
		TriggerScreenblurFadeOut(0)
...
RegisterNetEvent('ffrp-login:SetStates')
AddEventHandler('ffrp-login:SetStates', function()
	TriggerServerEvent("ffrp-clothes:get_character_current")
	...
	TriggerServerEvent('ffrp-motels:GetHotel')
