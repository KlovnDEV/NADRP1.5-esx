...
ESX.RegisterServerCallback("ffrp_garages:isPlayerOwned", function(source, callback, plate)
...
RegisterServerEvent('ffrp_garages:pay')
AddEventHandler('ffrp_garages:pay', function()
	local xPlayer = ESX.GetPlayerFromId(source)
	xPlayer.removeMoney(200)
end)

RegisterServerEvent('ffrp_garages:modifystate')
AddEventHandler('ffrp_garages:modifystate', function(vehicleProps, state, garage)
...
RegisterServerEvent('ffrp_garages:resetOutVehicles')
AddEventHandler('ffrp_garages:resetOutVehicles', function()
...
RegisterServerEvent('ffrp-garages:attemptRent')
AddEventHandler('ffrp-garages:attemptRent', function(bike)
	local src = source
	...
	if bike == 'bmx' then
		...
		if cash >= 200 then
			...
			TriggerClientEvent('ffrp-garages:SpawnRental', src, bike)
		else
...
RegisterServerEvent('ffrp-garages:returnRental')
AddEventHandler('ffrp-garages:returnRental', function()
	local src = source
	local user = ESX.GetPlayerFromId(src)
	if not recent then 
		recent = true
