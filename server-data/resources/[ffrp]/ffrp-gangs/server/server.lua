...
RegisterServerEvent('ffrp-selldrugs:completeSale')
AddEventHandler('ffrp-selldrugs:completeSale', function(NPC, salePrice)
...
RegisterServerEvent('ffrp-drugs:coke:status')
AddEventHandler('ffrp-drugs:coke:status', function()
	local user = ESX.GetPlayerFromId(source)
	if cocaine_status ~= nil then
		TriggerClientEvent('ffrp-gangs:currentCokeStatus', user.source, cocaine_percent, cocaine_status, cocaine_amount)
		if cocaine_status == 0 then
			cocaine_status = 1
			TriggerClientEvent('ffrp-gangs:startTask', user.source, math.random(1,5), 0)
		end
	end
end)

RegisterServerEvent('ffrp-gangs:coke:updatepercent')
AddEventHandler('ffrp-gangs:coke:updatepercent', function()
...
RegisterServerEvent('ffrp-gangs:coke:removeBrick')
AddEventHandler('ffrp-gangs:coke:removeBrick', function()
	local src = source
