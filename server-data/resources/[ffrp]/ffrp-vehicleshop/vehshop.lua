...
RegisterCommand('commission', function(source, args, raw)
	...
	if job == 'pdm' then
		...
		elseif amount ~= nil and amount < 0 then 
			exports['ffrp-log']:AddLog('exploiter', name, ident, 'pdm', log)
		else
	...
	elseif job == 'tuner' then
		...
		elseif amount ~= nil and amount < 0 then
			exports['ffrp-log']:AddLog('exploiter', name, ident, 'tuner', log)
		else
			exports['mythic_notify']:SendAlert('inform', 'Invalid amount "/commision [amount]"')
		end
	elseif job == 'cardealer' then
		...
		elseif amount ~= nil and amount < 0 then
			exports['ffrp-log']:AddLog('exploiter', name, ident, 'imports', log)
		else
			exports['mythic_notify']:SendAlert('inform', 'Invalid amount "/commision [amount]"')
		end
	elseif job == 'bikedealer' then
		...
		elseif amount ~= nil and amount < 0 then
			exports['ffrp-log']:AddLog('exploiter', name, ident, 'bikedealer', log)
		else
			exports['mythic_notify']:SendAlert('inform', 'Invalid amount "/commision [amount]"')
		end
	else
