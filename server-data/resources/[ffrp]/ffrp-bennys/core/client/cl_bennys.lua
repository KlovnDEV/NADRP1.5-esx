...
function AttemptPurchase(type, upgradeLevel)
    ...
    TriggerServerEvent("ffrp-bennys:attemptPurchase", type, upgradeLevel)
...
--#[Event Handlers]#--
RegisterNetEvent("ffrp-bennys:purchaseSuccessful")
AddEventHandler("ffrp-bennys:purchaseSuccessful", function()
    isPurchaseSuccessful = true
    attemptingPurchase = false
    -- TriggerEvent('DoLongHudText', 'Purchase Successful')
end)

RegisterNetEvent("ffrp-bennys:purchaseFailed")
AddEventHandler("ffrp-bennys:purchaseFailed", function()
