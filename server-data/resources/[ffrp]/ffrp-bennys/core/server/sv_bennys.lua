...
RegisterServerEvent('ffrp-bennys:attemptPurchase')
AddEventHandler('ffrp-bennys:attemptPurchase', function(type, upgradelevel)
	...
	if IsMechanicJobOnly then
	 	...
	 	if price < societyAccount.money then
			TriggerClientEvent("ffrp-bennys:purchaseSuccessful",source)
	 		societyAccount.removeMoney(price)
	 	else
	 		TriggerClientEvent('ffrp-bennys:purchaseFailed', _source)
...
RegisterServerEvent('ffrp-bennys:updateRepairCost')
AddEventHandler('ffrp-bennys:updateRepairCost', function(RepairCosts)
