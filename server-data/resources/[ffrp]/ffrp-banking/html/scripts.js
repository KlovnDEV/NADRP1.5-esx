...
$(document).ready(function(){
  ...
  document.onkeyup = function (data) {
    if (data.which == 27 ) {
      $.post('http://ffrp-banking/close', JSON.stringify({}));
    }
  };
  // Handle Button Presses
  $(".btnWithdraw").click(function(){
      $.post('http://ffrp-banking/withdraw', JSON.stringify({}));
  });
  $(".btnDeposit").click(function(){
      $.post('http://ffrp-banking/deposit', JSON.stringify({}));
  });
  $(".btnTransfer").click(function(){
      $.post('http://ffrp-banking/transfer', JSON.stringify({}));
  });
  $(".btnBalance").click(function(){
      $.post('http://ffrp-banking/balance', JSON.stringify({}));
  });
  $('.btnQuick').click($.throttle( 2000, true, function(e){
    $.post('http://ffrp-banking/quickCash', JSON.stringify({}));
  }));
  ...
  $("#withdraw-form").submit(function(e) {
      e.preventDefault();
      $.post('http://ffrp-banking/withdrawSubmit', JSON.stringify({
  ...
  $("#deposit-form").submit(function(e) {
      e.preventDefault();
      $.post('http://ffrp-banking/depositSubmit', JSON.stringify({
  ...
  $("#transfer-form").submit(function(e) {
      e.preventDefault();
      $.post('http://ffrp-banking/transferSubmit', JSON.stringify({
