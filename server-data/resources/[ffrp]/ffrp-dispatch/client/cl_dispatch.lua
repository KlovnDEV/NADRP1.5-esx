...
Citizen.CreateThread(function()
	while true do
        Citizen.Wait(0)
        if (IsControlJustReleased(0, 57) and (job == 'ambulance' or job == 'mechanic' or job == 'police') and not exports["ffrp-death"]:GetDeath()) then
...
RegisterNetEvent('ffrp-dispatch:AlertBanktruck')
AddEventHandler('ffrp-dispatch:AlertBanktruck', function()
  AlertBankTruck()
end)
