...
RegisterNUICallback('register', function(data, cb)
	...
	if reason == "" then
		...
		TriggerEvent("ffrp-clothes:defaultReset", myIdentity.sex)
		TriggerEvent('chat:addMessage', {
			template = '<div style="padding: 0.6vw; padding-left: 0.8vw; background-color: rgba(207, 125, 25, 0.9); border-radius: 6px;"><span style="width: 100%; font-weight: bold;">[SYSTEM]: </span>Welcome to FFRP!, Make sure to join the discord @discord.io/FadeFusionRP check out all the rules.</div>',
			args = {}
		})
		Wait(10000)
		TriggerEvent('chat:addMessage', {
		...
		TriggerEvent('phone:addnotification','Newbie', 'Welcome to FFRP. We sent you some starting items. Enjoy!')
