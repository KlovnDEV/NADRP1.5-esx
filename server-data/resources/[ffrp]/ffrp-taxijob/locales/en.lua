Locales['en'] = {
  ...
  ['client_unconcious'] = 'your client is unconscious, look for another one',
  ['arrive_dest'] = 'you have arrived at your destination',
  ['take_me_to_near'] = 'Take me to, near ',
  ['take_me_to'] = 'Take me to',
  ['close_to_client'] = 'you are too far from the client, get close to them',
  ['return_to_veh'] = 'please return to your vehicle to continue the job',
  ['must_in_taxi'] = 'you must be in a taxi to start the job',
  ['must_in_vehicle'] = 'you must be in a vehicle to begin the job',
