Locales['br'] = {
  ...
  ['customer_found'] = 'Você ~b~encontrou~s~ um passageiro, dirija até o destino',
  ['client_unconcious'] = 'Seu passageiro está ~r~insconsciente~s~. Procure por outro.',
  ['arrive_dest'] = 'Você ~b~chegou~s~ ao seu destino',
  ...
  ['have_earned'] = 'Você ganhou ~b~$%s~s~',
  ['comp_earned'] = '- Sua empresa ganhou ~b~$%s~s~\n- Você ganhou ~b~$%s~s~',
