Locales['sv'] = {
  ...
  ['customer_found'] = 'du har ~b~hittat~s~ en kund!',
  ['client_unconcious'] = 'din kund är ~r~medvetslös~s~. Hitta en ny.',
  ['arrive_dest'] = 'du har ~b~anlänt~s~ till din destination',
  ...
  ['have_earned'] = 'du har tjärnat ~b~%s SEK~s~',
  ['comp_earned'] = '- ditt företag har tjärnat ~b~%s SEK~s~\n- du har tjärnat ~b~%s SEK~s~',
