Citizen.CreateThread(function()
	exports["nadrp-polyzone"]:AddBoxZone("casino_enter", vector3(928.45, 44.56, 81.1), 11.6, 5.4, {
		heading=327,
		minZ=80.1,
		maxZ=82.9,
		data = {
	...
	exports["nadrp-polyzone"]:AddBoxZone("casino_exit", vector3(1089.72, 206.58, -49.0), 2.4, 7.0, {
		heading=0,
		minZ=-50.2,
		maxZ=-47.2,
		data = {
	...
	exports["nadrp-polyzone"]:AddBoxZone("elevator_roof", vector3(964.33, 58.88, 112.56), 2.0, 2, {
		heading=327,
		minZ=111.61,
		maxZ=114.01,
		data = {
	...
	exports["nadrp-polyzone"]:AddBoxZone("elevator_inside", vector3(1085.75, 214.75, -49.2), 2.6, 2.2, {
		heading=45,
		minZ=-52.5,
		maxZ=-47.9,
		data = {
...
function UseElevator(name)
	...
	if name == "roof" then
		...
		Wait(500)
		DoScreenFadeIn(500)
		TriggerEvent('nadrp-casino:InCasino', true)
	elseif name == "inside" then
		...
		Wait(500)
		DoScreenFadeIn(500)
		TriggerEvent('nadrp-casino:InCasino', false)
	end
	exports["nadrp-notify"]:ShowPersistAlert('[E] - Elevator', 'info', 'hide')
end
...
AddEventHandler('nadrp-polyzone:enter', function(zone, data, center)
	...
	elseif zone == "elevator_inside" then
		...
		KeypressThread()
		exports["nadrp-notify"]:ShowPersistAlert('[E] - Elevator', 'info', 'show')
