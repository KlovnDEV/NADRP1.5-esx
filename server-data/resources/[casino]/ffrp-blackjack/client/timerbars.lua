...
Citizen.CreateThread(function()
	exports["ffrp-polyzone"]:AddBoxZone("blackJack", vector3(1148.46, 269.95, -51.84), 2.8, 4.2, {
        heading=51,
        --debugPoly=true,
        minZ= -52.84,
        maxZ= -50.44,
	...
	exports["ffrp-polyzone"]:AddBoxZone("blackJack", vector3(1151.99, 266.4, -51.84), 2.6, 3.6, {
        heading=44,
        --debugPoly=true,
        minZ= -52.84,
        maxZ= -50.64,
	...
	exports["ffrp-polyzone"]:AddBoxZone("blackJack", vector3(1146.58, 260.92, -51.84), 4.0, 2.6, { 
        heading=312,
        --debugPoly=true,
        minZ= -52.84,
        maxZ= -50.64,
	...
	exports["ffrp-polyzone"]:AddBoxZone("blackJack", vector3(1143.11, 264.44, -51.84), 3.6, 2.8, {
		heading=315,
		--debugPoly=true,
		minZ= -53.04,
		maxZ= -49.84,
    ...
    exports["ffrp-polyzone"]:AddBoxZone("blackJack", vector3(1129.62, 262.56, -51.04), 2.6, 4.2,  {
        heading=310,
        --debugPoly=true,
        minZ= -52.84,
        maxZ= -49.64,
    ...
    exports["ffrp-polyzone"]:AddBoxZone("blackJack", vector3(1133.44, 266.61, -51.04), 4.2, 2.6, {
        heading=45,
        --debugPoly=true,
        minZ= -52.84,
        maxZ= -49.64,
    ...
    exports["ffrp-polyzone"]:AddBoxZone("blackJack", vector3(1148.66, 251.76, -51.04), 4.0, 2.6, {
        heading=35,
        --debugPoly=true,
        minZ= -52.84,
        maxZ= -49.64,
    ...
    exports["ffrp-polyzone"]:AddBoxZone("blackJack", vector3(1144.67, 247.74, -51.04), 4.2, 2.8, {
        heading=45,
        --debugPoly=true,
        minZ= -52.84,
        maxZ= -49.64,
