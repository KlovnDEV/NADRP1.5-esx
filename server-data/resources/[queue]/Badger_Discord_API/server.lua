...
Citizen.CreateThread(function()
	...
	justStarted = true
	Citizen.SetTimeout((60 * 1000) * 3, function()
		justStarted = false
	end)
end)
...
card = '{"type": "AdaptiveCard","$schema": "http://adaptivecards.io/schemas/adaptive-card.json","version": "1.3","body": [{"type": "Container","items": [{"type": "Image","url": "' .. Config.Splash.Header_IMG .. '","horizontalAlignment": "Center","size": "Large"},{"type": "TextBlock","text": "NightAndDayRP","wrap": true,"fontType": "Default","size": "ExtraLarge","weight": "Bolder","color": "Light","horizontalAlignment": "Center"},{"type": "TextBlock","text": "' .. Config.Splash.Heading1 .. '","wrap": true,"size": "Large","weight": "Bolder","color": "Light","horizontalAlignment": "Center"},{"type": "TextBlock","text": "' .. Config.Splash.Heading2 .. '","wrap": true,"color": "Light","size": "Medium","horizontalAlignment": "Center"},{"type": "ActionSet","actions": [{	"type": "Action.OpenUrl",	"title": "Join Discord",	"style": "destructive",	"iconUrl": "https://cdn.discordapp.com/attachments/705817451245600798/793492968962261052/modcheck.gif",	"url": "https://discord.gg/ceZZ8e5cck"}]}],"style": "default","bleed": true,"height": "stretch","isVisible": true,"backgroundImage": {"url": "https://wallpaperaccess.com/full/707055.jpg"}}],"backgroundImage": {"url": "https://wallpaperaccess.com/full/707055.jpg"}}'
...
if Config.Splash.Enabled then
	AddEventHandler('playerConnecting', function(name, setKickReason, deferrals) 
		...
		local toEnd = false;
		local count = 0;
		local HasServerJustStarted = justStarted
		while not toEnd do
			if HasServerJustStarted then 
				WaitMSG = '"The server is still starting please wait: '..(178 - count)..' seconds"'
			else
				WaitMSG = '"Please Wait: '..(Config.Splash.Wait - count)..' "'
			end
			card = '{"type": "AdaptiveCard","$schema": "http://adaptivecards.io/schemas/adaptive-card.json","version": "1.3","body": [{"type": "Container","items": [{"type": "Image","url": "' .. Config.Splash.Header_IMG .. '","horizontalAlignment": "Center","size": "Large"},{"type": "TextBlock","text": "Welcome to nadrp","wrap": true,"fontType": "Default","size": "ExtraLarge","weight": "Bolder","color": "Dark","horizontalAlignment": "Center"},{"type": "TextBlock","text":'..WaitMSG..',"wrap": true,"color": "Dark","size": "Medium", "Wight": "Bolder", "horizontalAlignment": "Center"},{"type": "ActionSet","actions": [{"type": "Action.OpenUrl","title": "Join Discord","style": "destructive","iconUrl": "https://cdn.discordapp.com/attachments/705817451245600798/793492968962261052/modcheck.gif","url": "https://discord.gg/ceZZ8e5cck"}]}],"style": "default","bleed": true,"height": "stretch","backgroundImage": {"url": "https://wallpaperaccess.com/full/707055.jpg"}}],"backgroundImage": {"url": "https://wallpaperaccess.com/full/707055.jpg"}}'
