...
Config.Database = 'mysql-async' --[ 'mysql-async' / 'oxmysql' / 'ghmattimysql' ] Choose your sql driver
Config.Framework = 'esx' --[ 'esx' / 'qbcore' / 'other' ] Choose your framework

Config.FrameworkTriggers = {
    load = 'tac:playerLoaded', --[ ESX = 'esx:playerLoaded'    QBCore = 'QBCore:Server:OnPlayerLoaded' ] Set the player load event, if left blank, default will be used
    ...
    object = 'tac:getSharedObject', --[ ESX = 'esx:getSharedObject'    QBCore = 'QBCore:GetObject' ] Set the shared object event, if left blank, default will be used (deprecated for QBCore)
...
Config.GangOptions = {
    ...
    sellMoreDrugs = false, -- Sell more than one drug at a time
