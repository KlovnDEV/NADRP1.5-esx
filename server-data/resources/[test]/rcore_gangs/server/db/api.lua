CreateThread(function()
    ...
    FetchGangMembers = function(gangId)
        ...
        if Config.Framework and string.gsub(string.lower(Config.Framework), '^%s*(.-)%s*$', '%1') == 'esx' then
            return DB.fetchAll(string.format(queryString, "CONCAT(firstname, ' ', lastname)", _identifier, _table), {
                ['@gangId'] = gangId
            })
        elseif Config.Framework and string.gsub(string.lower(Config.Framework), '^%s*(.-)%s*$', '%1') == 'qbcore' then
    ...
    if Config.Framework and (string.gsub(string.lower(Config.Framework), '^%s*(.-)%s*$', '%1') == 'esx' or string.gsub(string.lower(Config.Framework), '^%s*(.-)%s*$', '%1') == 'qbcore') then
