...
rootMenuConfig =  {
    {
        ...
        icon = "#globe-europe",
        enableMenu = function()
        fuck = exports["nadrp-death"]:GetDeath()
            return not fuck
        end,
    ...
    },
    {
        ...
        enableMenu = function()
        NearStation = exports["nadrp-trains"]:IsNearStation()
        fuck = exports["nadrp-death"]:GetDeath()
   ...
   --[[{
    ...
    },]]
    {
        ...
        local ped = PlayerPedId()
            fuck = exports["nadrp-death"]:GetDeath()
            local GetCuffs = exports['nadrp-inventory']:hasEnoughOfItem('cuffs', 1, false)
...
--[[{
    ...
    },
    {
        ...
        icon = "#cocaine-status",
        functionName = "nadrp-gangs:cokestatus",
        enableMenu = function()
        fuck = exports["nadrp-death"]:GetDeath()
        ...
        icon = "#cocaine-crate",
        functionName = "nadrp-gangs:removeBrick",
        enableMenu = function()
        fuck = exports["nadrp-death"]:GetDeath()
            if not fuck and #(GetEntityCoords(PlayerPedId()) - vector3(1087.3937988281,-3194.2138671875,-38.993473052979)) < 0.5 then
                return true
...
--[[     ['judge-raid:checkowner'] = {
    ...
    ['cuffs:softcuff'] = {
        title = "Soft Cuff",
        icon = "#cuffs-cuff",
        functionName = "nadrp-policejob:softcuff"
    },
    ['cuffs:uncuff'] = {
        title = "Uncuff",
        icon = "#cuffs-uncuff",
        functionName = "nadrp-policejob:uncuff"
    },
--[[     ['cuffs:remmask'] = {
    ...
    ['medic:revive'] = {
        title = "Revive",
        icon = "#medic-revive",
        functionName = "nadrp-ems:revive"
    },
    ['medic:heal'] = {
        title = "Treat Small Wounds",
        icon = "#medic-heal",
        functionName = "nadrp-ems:heal"
    },
    ['medic:bigheal'] = {
        title = "Treat Serious Wounds",
        icon = "#medic-heal",
        functionName = "nadrp-ems:bigheal"
    },
    ['medic:putinvehicle'] = {
...
AddEventHandler("nadrp-policejob:HandCuffedState", function(pIsHandcuffed, pIsHandcuffedAndWalking)
