...
Config.BigRewarditemChance = 15 -- Percentage of getting rare item on oxy run. Multiplied by 100. 0.1% = 1, 1% = 10, 20% = 200, 50% = 500, etc. Default 0.1%.
Config.BigRewarditem = { -- Put a rare item here which will have 0.1% chance of being given on the run.
    'securityblack',
    'securityblue',
    'securitygreen',
    'securityred',
