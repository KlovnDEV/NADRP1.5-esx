...
local function saveVehicle()
    ...
    TriggerServerEvent('bennys:setXenon',plate,vehicleMods.xenonColor)
...
function AttemptPurchase(type, upgradeLevel)
    ...
    TriggerServerEvent("nadrp-bennys:attemptPurchase", type, upgradeLevel)
...
--#[Event Handlers]#--
RegisterNetEvent("nadrp-bennys:purchaseSuccessful")
AddEventHandler("nadrp-bennys:purchaseSuccessful", function()
    isPurchaseSuccessful = true
    attemptingPurchase = false
    -- TriggerEvent('DoLongHudText', 'Purchase Successful')
end)

RegisterNetEvent("nadrp-bennys:purchaseFailed")
AddEventHandler("nadrp-bennys:purchaseFailed", function()
