...
$('.create-button').click(function () {
    ...
    $.post("http://nadrp-login/CharacterChosen", JSON.stringify({
...
$("#deletechar").click(function () {
	...
	if (chosenCharacterId > 0) {
		$.post("http://nadrp-login/DeleteCharacter", JSON.stringify({
			charid: chosenCharacterId,
		}));
    }
    ...
    window.onload = function(e) {
        ...
        document.onkeydown = function(data) {
            if (data.which == 13 && IsInMainMenu) {
                ...
                $.post("http://nadrp-login/ShowSelection", JSON.stringify({}));
                ShowLoading(true)
            }
        }
    }
