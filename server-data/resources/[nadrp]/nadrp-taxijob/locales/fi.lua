Locales['fi'] = {
  ...
  ['customer_found'] = 'Sinä ~b~löysit~s~ asiakkaan, aja lähemmäksi',
  ['client_unconcious'] = 'Sinun asiakkaasi on ~r~tajuton~s~. Etsi uusi.',
  ['arrive_dest'] = 'Sinä ~b~saavuit~s~ kohteeseen',
  ...
  ['have_earned'] = 'Sinä tienasit ~b~€%s~s~',
  ['comp_earned'] = '- Yrityksesi tienasi ~b~€%s~s~\n- Sinä tienasit ~b~€%s~s~',
