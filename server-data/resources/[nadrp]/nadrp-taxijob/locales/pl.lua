Locales['pl'] = {
  ...
  ['customer_found'] = '~b~Znajdujesz~s~ klienta, jedź do niego',
  ['client_unconcious'] = 'klient jest ~r~nieprzytomny~s~. Poszukaj innego.',
  ['arrive_dest'] = '~b~Dojeżdżasz~s~ do celu',
  ...
  ['have_earned'] = 'zarabiasz ~b~$%s~s~',
  ['comp_earned'] = '- Twoja firma zarobiła ~b~$%s~s~\n- Zarabiasz ~b~$%s~s~',
