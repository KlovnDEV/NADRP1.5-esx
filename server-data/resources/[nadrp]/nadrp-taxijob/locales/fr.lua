Locales['fr'] = {
  ...
  ['customer_found'] = 'vous avez ~b~trouvé~s~ un client, conduisez jusqu\'à ce dernier',
  ['client_unconcious'] = 'votre client est ~r~inconscient~s~. Cherchez-en un autre.',
  ['arrive_dest'] = 'vous êtes ~b~arrivé~s~ à destination',
  ...
  ['have_earned'] = 'vous avez gagné ~b~$%s~s~',
  ['comp_earned'] = '- Votre société a gagné ~b~$%s~s~\n- Vous avez gagné ~b~$%s~s~',
