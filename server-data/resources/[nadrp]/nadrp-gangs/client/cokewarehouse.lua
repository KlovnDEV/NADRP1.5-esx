...
RegisterNetEvent('nadrp-gangs:startTask')
AddEventHandler('nadrp-gangs:startTask', function(passedid,amount)
...
RegisterNetEvent('nadrp-gangs:cokestatus')
AddEventHandler('nadrp-gangs:cokestatus', function()
    if IsCokeWhitelisted() then 
        TriggerServerEvent('nadrp-drugs:coke:status')
    end
end)

RegisterNetEvent('nadrp-gangs:currentCokeStatus')
AddEventHandler('nadrp-gangs:currentCokeStatus', function(cocaine_percent,cocaine_status,cocaine_amount)
...
RegisterNetEvent('nadrp-gangs:removeBrick')
AddEventHandler('nadrp-gangs:removeBrick', function()
    if IsCokeWhitelisted() then
        TriggerServerEvent('nadrp-gangs:coke:removeBrick')
    end
end)
