...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if WarMenu.IsMenuOpened("emotes") then
            ...
            DrawText3Ds(plyCoords["x"],plyCoords["y"],plyCoords["z"]+0.4,"~b~Enter~s~ Plays Emote")
            DrawText3Ds(plyCoords["x"],plyCoords["y"],plyCoords["z"]+0.3,"~b~Arrows~s~ Navigate Pages")
            DrawText3Ds(plyCoords["x"],plyCoords["y"],plyCoords["z"]+0.2,"~b~Backspace~s~ Exits")
            DrawText3Ds(plyCoords["x"],plyCoords["y"],plyCoords["z"]+0.1,"~b~F3-F10~s~ Saves Emote")
            DrawText3Ds(plyCoords["x"],plyCoords["y"],plyCoords["z"],"~b~Shift~s~ with F keys saves also. (F8 Doesnt Save)")
            DrawText3Ds(plyCoords["x"],plyCoords["y"],plyCoords["z"]-0.1,"You can also type ~b~/e emotename~s~ in chat to perform them")
