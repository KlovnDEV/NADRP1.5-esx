...
RegisterNetEvent('dispatch:clNotifyM')
AddEventHandler('dispatch:clNotifyM', function(pNotificationData)
  if pNotificationData ~= nil then
...
Citizen.CreateThread(function()
	while true do
        Citizen.Wait(0)
        if (IsControlJustReleased(0, 57) and (job == 'ambulance' or job == 'mechanic' or job == 'police') and not exports["nadrp-death"]:GetDeath()) then
...
RegisterNetEvent('nadrp-dispatch:AlertBanktruck')
AddEventHandler('nadrp-dispatch:AlertBanktruck', function()
  AlertBankTruck()
end)
...
AddEventHandler("civilian:alertPolice",function(basedistance,alertType,objPassed,isGunshot,isSpeeder)
    ...
    if nearNPC == nil and alertType ~= "robberyhouseMansion" and not pd then
      ...
      if alertType == "robberyhouseMansion" then 
        alertType = "houserob" 
      end
    ...
    if alertType == "vangelico" then
      AlertJewelRob()  
    end
    if alertType == "meth" then
      AlertMeth()
    end
    if alertType == "weed" then
      AlertWeed()
    end
    if alertType == "mechanic" then
      AlertMechanic()
    end
    ...
    if alertType == "fleeca" then
      AlertFleecaRobbery()
    end

    if alertType == "atmrob" then
      AlertAtm()
    end
    ...
    if alertType == "storerobbed" then
      AlertStoreRobbed()
    end
    if alertType == "houserob" then
      AlertCheckRobbery2()
    end
...
function AlertFight()
  ...
  --if job == 'police' then
    TriggerServerEvent('dispatch:svNotify', {
      ...
      dispatchMessage = "Ongoing Fight",
      blipSprite = 458,
      blipColor = 25
    })

    TriggerServerEvent('tac_outlawalert:combatInProgress', plyPos)
...
function AlertGunShot()
    Citizen.CreateThread(function() 
      ...
      local eventId = uuid()
        ...
        TriggerServerEvent('tac_outlawalert:gunshotInProgress', plyPos)
        Wait(math.random(5000,10000))

        if math.random(1,10) > 3 and IsPedInAnyVehicle(ped) and not isInVehicle then
          vehicleData = GetVehicleDescription() or {}
          plyPos = GetEntityCoords(ped)
         -- if job == 'police' then
            TriggerServerEvent('dispatch:svNotify', {
              dispatchCode = '10-31B',
...
function CarCrash()
  ...
  --if job == 'police' or job == 'ambulance' then
    TriggerServerEvent('dispatch:svNotify', {
      ...
      --TriggerEvent('tac-alerts:vehiclecrash')
      TriggerServerEvent('tac_outlawalert:1050',targetCoords)
      Wait(math.random(5000,15000))
...
function AlertDeath()
  ...
  --if job == 'police' or job == 'ambulance' then
    TriggerServerEvent('dispatch:svNotify', {
      ...
      isImportant = false,
      priority = 3,
      dispatchMessage = "Injured Civilian",
      origin = {
        x = plyPos.x,
        y = plyPos.y,
        z = plyPos.z
    ...
    TriggerServerEvent('tac_outlawalert:injured', plyPos)
  --end
end
...
function AlertCheckLockpick(object)
  ...
  if not DoesEntityExist(targetVehicle) then
    ...
    TriggerServerEvent('dispatch:svNotify', {
      ...
      isImportant = false,
      priority = 1,
      dispatchMessage = "Vehicle Theft Report",
      origin = {
        x = plyPos.x,
        y = plyPos.y,
        z = plyPos.z
    ...
    TriggerServerEvent('tac_outlawalert:carJackInProgress',plyPos)
    return
    end
  end
end

function AlertStoreRobbed()
  local street1 = GetStreetAndZone()
  local esxder = IsPedMale(PlayerPedId())
  local plyPos = GetEntityCoords(PlayerPedId())

  local dispatchCode = "10-90B"
  local eventId = uuid()
  --if job == 'police' then
    TriggerServerEvent('dispatch:svNotify', {
      dispatchCode = dispatchCode,
    ...
    TriggerServerEvent('tac_outlawalert:StoreInProgress', plyPos)
    Wait(math.random(5000,15000))
...
function AlertCheckRobbery2(coords)
  local street1 = GetStreetAndZone()
  local esxder = IsPedMale(PlayerPedId()) 
  --local plyPos = GetEntityCoords(PlayerPedId())
  ...
  --if job == 'police' then
    ...
    TriggerServerEvent('tac_outlawalert:HouseRobInProgress', coords)
    Wait(math.random(5000,15000))
...
function AlertBankTruck()
  ...
  --if job == 'police' then
    TriggerServerEvent('dispatch:svNotify', {
      ...
      isImportant = true,
      priority = 1,
      dispatchMessage = "Bank Truck in Progress",
      origin = {
        x = plyPos.x,
        y = plyPos.y,
        z = plyPos.z
    ...
    TriggerEvent('tac-alerts:banktruck')
    Wait(math.random(5000,15000))
...
function AlertJewelRob()
  ...
  --if job == 'police' then
    TriggerServerEvent('dispatch:svNotify', {
      ...
      isImportant = true,
      priority = 1,
      dispatchMessage = "Vangelico in progress!",
      origin = {
        x = plyPos.x,
        y = plyPos.y,
        z = plyPos.z
    ...
    TriggerServerEvent('tac_outlawalert:VanjelicoInProgress', plyPos)
    Wait(math.random(5000,15000))
...
function AlertPaletoBank()
  ...
  --if job == 'police' then
    TriggerServerEvent('dispatch:svNotify', {
      ...
      isImportant = true,
      priority = 1,
      dispatchMessage = "Paleto Bank Alarm Triggred!",
      origin = {
        x = plyPos.x,
        y = plyPos.y,
        z = plyPos.z
    ...
    TriggerServerEvent('tac_outlawalert:PaletoBank', plyPos)
    Wait(math.random(5000,15000))
...
function AlertMeth()
  ...
  --if job == 'police' then
    TriggerServerEvent('dispatch:svNotify', {
      ...
      isImportant = true,
      priority = 1,
      dispatchMessage = "Suspicious smoking vehicle located in Sandy Shores area",
      origin = {
        x = plyPos.x,
        y = plyPos.y,
        z = plyPos.z
...
function AlertWeed()
  ...
  if job == 'police' then
    TriggerServerEvent('dispatch:svNotify', {
      ...
      isImportant = true,
      priority = 1,
      dispatchMessage = "Trespassing in progress",
      origin = {
        x = plyPos.x,
        y = plyPos.y,
        z = plyPos.z
    ...
    TriggerServerEvent('tac_outlawalert:TressPass', plyPos)
  end
end

function AlertMechanic()
  local street1 = GetStreetAndZone()
  local esxder = IsPedMale(PlayerPedId())
  local plyPos = GetEntityCoords(PlayerPedId())
  local isInVehicle = IsPedInAnyVehicle(PlayerPedId())
  local dispatchCode = "Mechanic"
  local eventId = uuid()
  --if job == 'mechanic' then
    TriggerServerEvent('dispatch:svNotifyM', {
      dispatchCode = dispatchCode,
      firstStreet = street1,
      esxder = esxder,
      eventId = eventId,
    ...
    TriggerServerEvent('tac_outlawalert:mechanic', plyPos)
  --end
end
...
function AlertJailBreak()
  ...
  TriggerEvent('tac-alerts:jailbreak')
  Wait(math.random(5000,15000))
...
function DrugSale()
  ...
  --if job == 'police' then
    ...
    TriggerServerEvent('tac_outlawalert:drugSaleInProgress', plyPos)
  --end
end
...
function AlertFleecaRobbery()
  ...
  --if job == 'police' then
    ...
    TriggerServerEvent('tac_outlawalert:fleecaInProgress', plyPos)
    Wait(math.random(5000,15000))
...
function AlertAtm()
  ...
  --if job == 'police' then
    ...
    TriggerServerEvent('tac_outlawalert:atmInProgress', plyPos)
    Wait(math.random(5000,15000))
...
function PowerGrid()
  ...
  --if job == 'police' then
    TriggerServerEvent('dispatch:svNotify', {
      ...
      isImportant = true,
      priority = 1,
      dispatchMessage = "Disturbance At Powergrid!",
      origin = {
        x = plyPos.x,
        y = plyPos.y,
        z = plyPos.z
    ...
    TriggerServerEvent('tac_outlawalert:powerGridInProgress', plyPos)
    Wait(math.random(5000,15000))
...
RegisterNetEvent('tac-dispatch:gunshot')
AddEventHandler('tac-dispatch:gunshot', function(ped)
  AlertGunShot(ped)
end)

RegisterNetEvent('tac-dispatch:drugjob')
AddEventHandler("tac-dispatch:drugjob",function()
  AlertDrugJob()
end)

RegisterNetEvent('tac-dispatch:Fleecarobbery')
AddEventHandler("tac-dispatch:Fleecarobbery",function()
  AlertFleecaRobbery()
end)

RegisterNetEvent('tac-dispatch:jailbreak')
AddEventHandler("tac-dispatch:jailbreak",function()
  AlertJailBreak()
end)

RegisterNetEvent('tac-dispatch:jewelrobbery')
AddEventHandler("tac-dispatch:jewelrobbery",function()
  AlertJewelRob()
end)

RegisterNetEvent('tac-dispatch:houserobbery')
AddEventHandler("tac-dispatch:houserobbery",function(pCoords)
  AlertCheckRobbery2(pCoords)
end)

RegisterNetEvent('tac-dispatch:storerobbery')
AddEventHandler("tac-dispatch:storerobbery",function()
  AlertStoreRobbed()
end)

RegisterNetEvent('tac-dispatch:carjacking')
AddEventHandler("tac-dispatch:carjacking",function()
  AlertCheckLockpick(object)
end)

RegisterNetEvent("tac-dispatch:downplayer")
AddEventHandler("tac-dispatch:downplayer",function()
    AlertDeath()
end)

RegisterNetEvent('tac-dispatch:drugsale')
AddEventHandler("tac-dispatch:drugsale",function()
  DrugSale()
end)

RegisterNetEvent('tac-dispatch:powergrid')
AddEventHandler("tac-dispatch:powergrid",function()
  PowerGrid()
end)

RegisterNetEvent('tac-dispatch:PaletoBank')
AddEventHandler("tac-dispatch:PaletoBank",function()
  AlertPaletoBank()
end)
