...
AddEventHandler('es:playerLoaded', function(source)
	...
	TriggerClientEvent('tac_identity:saveID', source, myID)
	getIdentity(source, function(data)
		if data.firstname == '' then
			TriggerClientEvent('tac_identity:identityCheck', source, false)
			TriggerClientEvent('tac_identity:showRegisterIdentity', source)
		else
			TriggerClientEvent('tac_identity:identityCheck', source, true)
		end
	end)
end)
