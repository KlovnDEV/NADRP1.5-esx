...
AddEventHandler('housing:raid', function()
	if housenameraid ~= "none" and myhouseid ~= 0 then
		...
		TriggerServerEvent('nadrp-log:AddHousingLog',name,ident,'raid',log,housenameraid)
	end
end)
...
function buildApartment(heading)
	...
	local building = CreateObject(`nadrp_hotel`,generator.x,generator.y,generator.z,false,false,false)
