...
--local NearNPC = exports["nadrp-ped"]:GetClosestNPC()
--local handcuffed = exports["nadrp-ped"]:isPed("handcuffed")
--local NearNPC = exports["nadrp-ped"]:GetRandomNPC()
...
RegisterNetEvent("ped:callSign")
AddEventHandler("ped:callSign", function(pCallSign)
...
RegisterNetEvent("updatesteamid")
AddEventHandler("updatesteamid", function(steamidpassed)
    steamid = steamidpassed
end)
...
RegisterNetEvent("updatespawn")
AddEventHandler("updatespawn", function(newSpawn)
  spawnpos = newSpawn
end)
...
-- local countpolice = exports["nadrp-ped"]:isPed("femaleclothes")
RegisterNetEvent('pd:deathcheck')
AddEventHandler('pd:deathcheck', function()
	dead = not dead
end)

RegisterNetEvent('nadrp-policejob:HandCuffedState')
AddEventHandler('nadrp-policejob:HandCuffedState', function(handCuffed,handCuffedWalking)
...
AddEventHandler('nadrp-banking:updateBalance', function(amount)
...
RegisterNetEvent('nadrp-ped:UpdateCash')
AddEventHandler('nadrp-ped:UpdateCash', function(newCash)
  cash = newCash
end)

RegisterNetEvent('es:addedMoney')
AddEventHandler('es:addedMoney', function(amount, total)
  print('Added:', amount, total)
	cash = math.ceil(amount)
end)

RegisterNetEvent('es:removedMoney')
AddEventHandler('es:removedMoney', function(amount, total)
  print('Removed:', amount, total)
	cash = math.ceil(amount)
end)
