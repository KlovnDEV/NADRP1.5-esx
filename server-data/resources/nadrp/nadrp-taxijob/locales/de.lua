Locales['de'] = {
  ...
  ['customer_found'] = 'du hast einen Passagier ~b~gefunden~s~ , Fahre in zum Ziel',
  ['client_unconcious'] = 'dein Passagier ist ~r~bewusstlos~s~. Suche nach einem anderen.',
  ['arrive_dest'] = 'du bist an deinem Ziel ~b~angekommen~s~',
  ...
  ['have_earned'] = 'verdient ~b~$%s~s~',
  ['comp_earned'] = '- Die Firma verdient ~b~$\n- Verdient ~b~$%s~s~',
