    ...
    while true do
        if Zatrudniony then
            ...
            if Dystans <= 10.0 then
                ...
                ESX.Game.Utils.DrawText3D(PozycjaGarazu, "Press [~b~E~s~] to start work", 0.55, 1.5, "~b~PIZZA BOY", 0.7)
                if Dystans <= 3.0 then
    ...
    while true do
        ...
        if Dystans <= 40.0 and Zatrudniony and (not MaPaczke) then
            ...
            if IsVehicleModel(pojazd, GetHashKey('foodcar4')) then
                ...
                ESX.Game.Utils.DrawText3D(pozycjaPojazdu, "Press [~b~E~s~] to get ~y~Pizza", 1.0, 5.0, "~b~Panto", 1.15)
        ...
        elseif Dystans <= 25 and MaPaczke and Zatrudniony then
            ...
            ESX.Game.Utils.DrawText3D(PozycjaDostawy, "Press [~b~E~s~] to deliver ~y~Pizza", 0.55, 1.5, "~b~Delivery", 0.7)
            if Dystans <= 3 then
                if IsControlJustReleased(0, 38) then
                    WezPaczke()
                    DostarczPaczke()
        ...
        if PodczasSluzby then
            ...
            if Rozwieziono then
                ...
                if DystansOdStrefyZakonczenia <= 25 then
                    ...
                    ESX.Game.Utils.DrawText3D(Zakonczenie, "Press [~b~E~s~] to ~r~END~s~ the your shift", 1.4, 3.5, "~b~JOB END", 1.55)
                ...
                if DystansOdStrefyAnulowania <= 25 then
                    ...
                    ESX.Game.Utils.DrawText3D(Anulowanie, "Press [~b~E~s~] to ~r~CANCEL~s~ THE JOB", 1.4, 3.5, "~b~JOB CANCEL", 1.55)
