(function(t) {
    ...
    "2b0e": function(t, e, n) {
        ...
        n.r(e),
            function(t) {
                ...
                function Wt(t, e) {
                    ...
                    if (n) {
                        ...
                        if (Array.isArray(n)) {
                            ...
                            for (var s in n)(o = n[s]), (i = S(s)), (a[i] = u(o) ? o : {
                                type: o
                            });
                        else 0;
                        t.props = a;
                ...
                function Yt(t, e, n) {
                    if (("function" === typeof e && (e = e.options), Wt(e, n), Ut(e, n), Gt(e), !e._base && (e.extends && (t = Yt(t, e.extends, n)), e.mixins)))
                ...
                function pn(t, e, n, r, i) {
                    ...
                    (Array.isArray(r) && "function" === typeof r[0] && ((n = n || {}), (n.scopedSlots = {
                        default: r[0]
                    }), (r.length = 0)), i === un ? (r = Ce(r)) : i === ln && (r = ke(r)), "string" === typeof e) ?
                ...
                function jr(t) {
                    D.forEach(function(e) {
                        t[e] = function(t, n) {
                            return n ?
                                ("component" === e && u(n) && ((n.name = n.name || t), (n = this.options._base.extend(n))), "directive" === e && "function" === typeof n && (n = {
                                    bind: n,
                                    update: n
                ...
                var ga = {
                    ...
                    render: function(t) {
                        for (
                            var e = this.tag || this.$vnode.data.tag || "span", n = Object.create(null), r = (this.prevChildren = this.children), o = this.$slots.default || [], i = (this.children = []), a = ua(this), s = 0; s < o.length; s++
                        ) {
                            var c = o[s];
                            if (c.tag)
        ...
        var r = n("2b0e"),
            o = function() {
                ...
                return n(
                    ...
                    [
                        t.notifications || t.showDispatchLog ? n("DispatchLog", {
                            attrs: {
                ...
                function() {
                    ...
                    return t.showDispatchLog ?
                        n(
                            "div", {
                                ref: "dispatchLog",
                                staticClass: "dispatch-log-container vue-notification-group scrollbar--dark"
                            },
                            t._l(t.notifications.slice().reverse(), function(t, e) {
                                return n("div", {
                                    key: e,
                                    staticClass: "dispatch-log-notification",
                                    attrs: {
                                        item: t
                                    }
                                }, [n("Notification", {
            ...
            c = function() {
                var t = this,
                    ...
                    n = t._self._c || e;
                return n("div", {
                    class: ["vue-notification", t.notification.type, {
                    ...
                    t.notification.callSign ? n("div", [n("font-awesome-icon", {
                        attrs: {
                            icon: ["fa", "id-badge"]
                        }
                    }), t._v(" " + t._s(t.notification.callSign) + " Distress call")], 1) : t._e(),
                    t.notification.location ? n("div", [n("font-awesome-icon", {
                        attrs: {
                            icon: ["fas", "globe-europe"]
                        }
                    }), t._v(" " + t._s(t.notification.location) + " ")], 1) : t._e(),
                    t.notification.heading ? n("div", [n("font-awesome-icon", {
                        attrs: {
                            icon: ["fa", "compass"]
                        }
                    }), t._v(" " + t._s(t.notification.heading) + " ")], 1) : t._e(),
                    ...
                    t._e(),
                    t.notification.model ? n("div", [n("font-awesome-icon", {
                        attrs: {
                            icon: ["fas", "palette"]
                        }
                    }), t._v(" " + t._s(t.notification.firstColor) + " and " + t._s(t.notification.secondColor) + " ")], 1) : t._e(),
                ]);
            },
            l = [],
            u = {
                ...
                methods: {
                    setGPSMarker: function(t) {
                        void 0 !== t && fetch("http://nadrp-dispatch/setGPSMarker", {
                            headers: {
            ...
            x = {
                ...
                mounted: function() {
                    ...
                    window.addEventListener("keyup", function(e) {
                        27 === e.keyCode && t.showDispatchLog && ((t.showDispatchLog = !1), fetch("http://nadrp-dispatch/disableGui"));
                    });
                },
                created: function() {
                    var t = this;
            ...
            if (!t.jQuery) {
                ...
                (e.each = function(t, e, n) {
                    ...
                    if (n) {
                        if (a) {
                            for (; o < i; o++)
                                if (((r = e.apply(t[o], n)), !1 === r)) break;
                        } else
                            for (o in t)
                                if (t.hasOwnProperty(o) && ((r = e.apply(t[o], n)), !1 === r)) break;
                    } else if (a) {
                        for (; o < i; o++)
                            if (((r = e.call(t[o], o, t[o])), !1 === r)) break;
                    } else
                        for (o in t)
                            if (t.hasOwnProperty(o) && ((r = e.call(t[o], o, t[o])), !1 === r)) break;
                    return t;
                }),
                            ...
                            switch (
                                (_(t) === r && m.init(t),
                                    ...
                                    f.queue(t, a.queue, function(e, n) {
                                        ...
                                        (_(t).delayBegin = new Date().getTime()), (_(t).delay = parseFloat(a.delay)), (_(t).delayTimer = {
    ...
    "65ee": function(t, e, n) {
        ...
        [].keys && ((i = [].keys()), "next" in i ? ((o = a(a(i))), o !== Object.prototype && (r = o)) : (p = !0)), void 0 == r && (r = {}), u || c(r, f) || s(r, f, d), (t.exports = {
            IteratorPrototype: r,
    ...
    ad3d: function(t, e, n) {
        ...
        (function(t) {
                    ...
                    (function(e) {
                        var n = function(t, e, r) {
                                ...
                                if (u(e))
                                    ...
                                    for (var s in ((o = {}), e)) Object.prototype.hasOwnProperty.call(e, s) && (o[t(s, r)] = n(t, e[s], r));
                                return o;
                            },
                            r = function(t, e) {
                                e = e || {};
            ...
            function h(t, e) {
                ...
                return "string" === typeof e ? e : t(e.tag, l({
                    class: v(i.class, s),
                    style: l({}, i.style, f),
                    attrs: l({}, i.attrs, y)
                }, g, {
    ...
    e379: function(t, e, n) {
        ...
        var r,
            ...
            it = function(t, e, n) {
                var r, o;
                G ? ((r = R.createEvent("Event")), (r.promise = e), (r.reason = n), r.initEvent(t, !1, !0), l.dispatchEvent(r)) : (r = {
                    promise: e,
                    reason: n
                }), (o = l["on" + t]) ? o(r) : t === Y && A("Unhandled promise rejection", n);
            },
            at = function(t, e) {
                k.call(l, function() {
                    var n,
    ...
    ecee: function(t, e, n) {
        ...
        (function(t) {
                    ...
                    e.push({
                        ...
                        children: [{
                            ...
                            children: [{
                                ...
                                attributes: c({}, r.icon.attributes, s.path)
                            }]
                        }]
                    });
                } else e.push(r.icon);
            ...
            function zt(t) {
                ...
                p && (g.attributes[N] = ""), l && g.children.push({
                    tag: "title",
                    attributes: {
                        id: g.attributes["aria-labelledby"] || "title-".concat(xt())
                    },
                    children: [l]
                });
                var b = c({}, g, {
                    ...
                    (a = Array.isArray(i) ?
                        {
                            tag: "g",
                            attributes: {
                                class: "".concat(B.familyPrefix, "-").concat(V.GROUP)
                            },
                            children: [{
                                    tag: "path",
                                    attributes: {
                                        class: "".concat(B.familyPrefix, "-").concat(V.SECONDARY),
                                        fill: "currentColor",
                                        d: i[0]
                                    }
                                },
                                {
                                    tag: "path",
                                    attributes: {
                                        class: "".concat(B.familyPrefix, "-").concat(V.PRIMARY),
                                        fill: "currentColor",
                                        d: i[1]
                                    }
                                },
            ...
            function oe(t) {
                return function(e) {
                    var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                        r = (e || {}).icon ? e : re(e || {}),
                        o = n.mask;
                    return o && (o = (o || {}).icon ? o : re(o || {})), t(r, c({}, n, {
                        mask: o
                    }));
                };
            }
                    ...
                    return ne({
                        ...
                        return ee(), Vt({
                            ...
                            extra: {
                                attributes: f,
                                styles: d,
                                classes: ["".concat(B.familyPrefix, "-layers-text")].concat(u(s))
                            }
                        });
                    });
                };
