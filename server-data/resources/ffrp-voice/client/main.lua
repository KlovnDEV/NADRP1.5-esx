...
RegisterNetEvent('ffrp-voice:SetRadioVolume')
AddEventHandler('ffrp-voice:SetRadioVolume', function(passedRadioVolume)
...
RegisterCommand('+cycleproximity', function()
	...
	TriggerEvent('ffrp-hud:UpdateVoice', voiceMode)
end, false)
RegisterCommand('-cycleproximity', function()
end)
...
AddEventHandler('onClientResourceStart', function(resource)
	...
	TriggerEvent('ffrp-hud:UpdateVoice', mode)
end)
