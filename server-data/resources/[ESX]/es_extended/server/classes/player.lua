function CreateExtendedPlayer(player, accounts, inventory, job, loadout, name, lastPosition)
	...
	self.setAccountMoney = function(acc, money)
		...
		TriggerClientEvent('tac:setAccountMoney', self.source, account)
	end
	...
	self.addInventoryItem = function(name, count)
		...
		TriggerEvent('tac:onAddInventoryItem', self.source, item, count)
		TriggerClientEvent('tac:addInventoryItem', self.source, item, count)
	end
	...
	self.removeInventoryItem = function(name, count)
		...
		TriggerEvent('tac:onRemoveInventoryItem', self.source, item, count)
		TriggerClientEvent('tac:removeInventoryItem', self.source, item, count)
	end
	...
	self.setInventoryItem = function(name, count)
		...
		if oldCount > item.count  then
			TriggerEvent('tac:onRemoveInventoryItem', self.source, item, oldCount - item.count)
			TriggerClientEvent('tac:removeInventoryItem', self.source, item, oldCount - item.count)
		else
			TriggerEvent('tac:onAddInventoryItem', self.source, item, item.count - oldCount)
			TriggerClientEvent('tac:addInventoryItem', self.source, item, item.count - oldCount)
		end
	end
	...
	self.addWeapon = function(weaponName, ammo)
		...
		TriggerClientEvent('tac:addWeapon', self.source, weaponName, ammo)
		TriggerClientEvent('tac:addInventoryItem', self.source, {label = weaponLabel}, 1)
	end
	...
	self.addWeaponComponent = function(weaponName, weaponComponent)
		...
		TriggerClientEvent('tac:addWeaponComponent', self.source, weaponName, weaponComponent)
	end
	...
	self.removeWeapon = function(weaponName, ammo)
		...
		for k,v in ipairs(self.loadout) do
			if v.name == weaponName then
				...
				for k2,v2 in ipairs(v.components) do
					TriggerClientEvent('tac:removeWeaponComponent', self.source, weaponName, v2)
				end
		...
		if weaponLabel then
			TriggerClientEvent('tac:removeWeapon', self.source, weaponName, ammo)
			TriggerClientEvent('tac:removeInventoryItem', self.source, {label = weaponLabel}, 1)
		end
	end
	...
	self.removeWeaponComponent = function(weaponName, weaponComponent)
		...
		TriggerClientEvent('tac:removeWeaponComponent', self.source, weaponName, weaponComponent)
	end
	...
	self.showNotification = function(msg, flash, saveToBrief, hudColorIndex)
		self.triggerEvent('tac:showNotification', msg, flash, saveToBrief, hudColorIndex)
	end

	self.showHelpNotification = function(msg, thisFrame, beep, duration)
		self.triggerEvent('tac:showHelpNotification', msg, thisFrame, beep, duration)
	end
