...
ESX.TriggerServerCallback = function(name, cb, ...)
	...
	TriggerServerEvent('tac:triggerServerCallback', name, ESX.CurrentRequestId, ...)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'inventory_item',
		{
			...
			if data1.current.action == 'give' then
				...
				ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'give_item_to',
				{
					...
					if type == 'item_weapon' then
						...
						TriggerServerEvent('tac:giveInventoryItem', GetPlayerServerId(nearbyPlayer), type, item, sourceAmmo)
						menu2.close()
						menu1.close()
						...
						ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'inventory_item_count_give', {
							...
							if quantity ~= nil then
								TriggerServerEvent('tac:giveInventoryItem', GetPlayerServerId(nearbyPlayer), type, item, quantity)
			...
			elseif data1.current.action == 'remove' then
				...
				if type == 'item_weapon' then
					...
					TriggerServerEvent('tac:removeInventoryItem', type, item)
					menu1.close()
					...
					ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'inventory_item_count_remove', {
						...
						if quantity == nil then
							...
							TriggerServerEvent('tac:removeInventoryItem', type, item, quantity)
							menu2.close()
							menu1.close()
						end
			...
			elseif data1.current.action == 'use' then
				TriggerServerEvent('tac:useItem', item)
...
RegisterNetEvent('tac:serverCallback')
AddEventHandler('tac:serverCallback', function(requestId, ...)
	ESX.ServerCallbacks[requestId](...)
	ESX.ServerCallbacks[requestId] = nil
end)

RegisterNetEvent('tac:showNotification')
AddEventHandler('tac:showNotification', function(msg)
	ESX.ShowNotification(msg)
end)

RegisterNetEvent('tac:showAdvancedNotification')
AddEventHandler('tac:showAdvancedNotification', function(title, subject, msg, icon, iconType)
	ESX.ShowAdvancedNotification(title, subject, msg, icon, iconType)
end)

RegisterNetEvent('tac:showHelpNotification')
AddEventHandler('tac:showHelpNotification', function(msg)
