Locales['cs'] = {
  ...
  ['gave_money'] = 'dali jste ~r~$%s~s~ ~y~%s~s~',
  ['received_money'] = 'obdrželi jste ~r~$%s~s~ od ~b~%s~s~',
  ['gave_account_money'] = 'dali jste ~r~$%s~s~ (%s) ~y~%s~s~',
  ['received_account_money'] = 'obdrželi jste ~r~$%s~s~ (%s) od ~b~%s~s~',
  ...
  ['money_set'] = 'někdo s ~y~vysokou úrovní~s~ vám právě nastavil ~r~$%s~s~ (%s)!',
