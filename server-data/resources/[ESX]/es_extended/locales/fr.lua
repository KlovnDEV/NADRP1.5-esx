Locales['fr'] = {
  ...
  ['gave_money'] = 'vous avez donné ~r~$%s~s~ à ~y~%s~s~',
  ['received_money'] = 'vous avez reçu ~r~$%s~s~ par ~b~%s~s~',
  ['gave_account_money'] = 'vous avez donné ~r~$%s~s~ (%s) à ~y~%s~s~',
  ['received_account_money'] = 'vous avez reçu ~r~$%s~s~ (%s) par ~b~%s~s~',
  ...
  ['money_set'] = 'quelqu\'un de ~y~haut placé~s~ vous a attribué ~r~$%s~s~ (%s) !',
