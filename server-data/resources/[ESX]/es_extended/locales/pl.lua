Locales['pl'] = {
  ...
  ['gave_money'] = 'dajesz ~r~%s$~s~ dla ~y~%s~s~',
  ['received_money'] = 'otrzymujesz ~r~%s$~s~ od ~b~%s~s~',
  ['gave_account_money'] = 'dajesz ~r~%s$~s~ (%s) dla ~y~%s~s~',
  ['received_account_money'] = 'otrzymujesz ~r~%s$~s~ (%s) od ~b~%s~s~',
  ...
  -- Salary related
  ['received_salary'] = 'otrzymałeś wynagrodzenie: ~r~%s$~s~',
  ['received_help'] = 'otrzymałem zapomogę: ~r~$%s~s~',
  ...
  ['money_set'] = 'ktoś ~y~wysoko postawiony~s~ podarował Ci pieniądze i masz teraz ~r~%s$~s~ (%s)!',
