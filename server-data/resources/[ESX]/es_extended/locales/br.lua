Locales['br'] = {
  ...
  ['gave_money'] = 'voce deu ~r~$%s~s~ para ~y~%s~s~',
  ['received_money'] = 'voce recebeu ~r~$%s~s~ de ~b~%s~s~',
  ['gave_account_money'] = 'voce deu ~r~$%s~s~ (%s) para ~y~%s~s~',
  ['received_account_money'] = 'voce recebeu ~r~$%s~s~ (%s) de ~b~%s~s~',
  ...
  -- Salary related
  ['received_salary'] = 'voce recebeu seu salario: ~r~$%s~s~ ',
