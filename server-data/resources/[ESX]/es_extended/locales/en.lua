Locales['en'] = {
  ...
  ['gave_weapon_ammo'] = 'you gave 1x %s with ~o~%sx bullets to %s.',
  ['gave_weapon_hasalready'] = '%s already have an %s',
  ['received_weapon'] = 'you received 1x %s from %s.',
  ['received_weapon_ammo'] = 'you received 1x %s with ~o~%sx bullets from %s.',
  ...
  ['gave_account_money'] = 'you gave ~r~$%s~s~ (%s) to ~y~%s~s~',
  ['received_account_money'] = 'you received ~r~$%s~s~ (%s) from ~b~%s~s~',
  ...
  ['received_help'] = 'you recieved your welfare check: ~r~$%s~s~',
  ...
  ['money_set'] = 'someone ~y~highly ranked~s~ just set ~r~$%s~s~ (%s) for you!',
