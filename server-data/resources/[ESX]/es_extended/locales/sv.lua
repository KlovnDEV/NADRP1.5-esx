Locales['sv'] = {
  ...
  ['gave_money'] = 'du gav ~r~%s SEK~s~ till ~y~%s~s~',
  ['received_money'] = 'du tog emot ~r~%s SEK~s~ från ~b~%s~s~',
  ['gave_account_money'] = 'du gav ~r~%s SEK~s~ (%s) till ~y~%s~s~',
  ['received_account_money'] = 'du tog emot ~r~%s SEK~s~ (%s) från ~b~%s~s~',
  ...
  ['money_set'] = 'någon ~y~högt uppsatt~s~ satte ~r~%s SEK~s~ (%s) för dig!',
