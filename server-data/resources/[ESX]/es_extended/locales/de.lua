Locales['de'] = {
  ...
  ['gave_money'] = 'du gibst ~r~$%s~s~ an ~y~%s~s~',
  ['received_money'] = 'du erhälst ~r~$%s~s~ von ~b~%s~s~',
  ['gave_account_money'] = 'du gibst ~r~$%s~s~ (%s) an ~y~%s~s~',
  ['received_account_money'] = 'du empfängst ~r~$%s~s~ (%s) von ~b~%s~s~',
