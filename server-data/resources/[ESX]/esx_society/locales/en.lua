Locales['en'] = {
  ...
  ['have_withdrawn']         = 'you have withdrawn ~r~$%s~s~',
  ...
  ['yes']                    = 'yes',
  ['you_have']               = 'you have ~r~$%s~s~ waiting in ~y~money laundering~s~ (24h).',
  ['you_have_laundered']     = 'you have ~r~laundered~s~ your money: ~r~$%s~s~',
