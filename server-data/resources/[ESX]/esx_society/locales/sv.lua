Locales['sv'] = {
  ...
  ['have_withdrawn']         = 'du har tagit ut ~r~%s SEK~s~',
  ...
  ['yes']                    = 'ja',
  ['you_have']               = 'du har ~r~%s SEK~s~ som väntar på ~y~pengartvätt~s~ (24h).',
  ['you_have_laundered']     = 'du har ~r~tvättat~s~ dina pengar: ~r~%s SEK~s~',
