...
function RefreshBussHUD()
	...
	if ESX.PlayerData.job.grade_name == 'boss' then
		...
		ESX.TriggerServerCallback('tac_society:getSocietyMoney', function(money)
			UpdateSocietyMoneyHUDElement(money)
		end, ESX.PlayerData.job.name)
	end
end

RegisterNetEvent('tac_addonaccount:setMoney')
AddEventHandler('tac_addonaccount:setMoney', function(society, money)
...
function EnableSocietyMoneyHUDElement()
	...
	TriggerEvent('tac_society:toggleSocietyHud', true)
end
...
function DisableSocietyMoneyHUDElement()
	...
	TriggerEvent('tac_society:toggleSocietyHud', false)
end
...
function UpdateSocietyMoneyHUDElement(money)
	...
	TriggerEvent('tac_society:setSocietyMoney', money)
end
...
function OpenBossMenu(society, close, options)
	...
	ESX.TriggerServerCallback('tac_society:isBoss', function(result)
		isBoss = result
	end, society)
...
function OpenEmployeeList(society)
	...
	ESX.TriggerServerCallback('tac_society:getEmployees', function(employees)
...
function OpenRecruitMenu(society)
	...
	ESX.TriggerServerCallback('tac_society:getOnlinePlayers', function(players)
...
function OpenPromoteMenu(society, employee)
	...
	ESX.TriggerServerCallback('tac_society:getJob', function(job)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'manage_grades_' .. society, {
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'manage_grades_amount_' .. society, {
				...
				elseif amount > Config.MaxSalary then
					...
					ESX.TriggerServerCallback('tac_society:setJobSalary', function()
						OpenManageGradesMenu(society)
...
AddEventHandler('tac_society:openBossMenu', function(society, close, options)
