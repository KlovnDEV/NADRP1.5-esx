...
RegisterNetEvent('nadrp-voice:SetRadioVolume')
AddEventHandler('nadrp-voice:SetRadioVolume', function(passedRadioVolume)
	setVolume(passedRadioVolume, "radio")
end)
...
local heliEffectId = 0
SetAudioSubmixEffectRadioFx(heliEffectId, 0)
...
AddEventHandler('baseevents:enteredVehicle', function(veh, seat)
	...
	if vehClass == 15 or vehClass == 16 then
		SetAudioSubmixEffectParamInt(heliEffectId, 0, `default`, 1)
	end
end)

RegisterNetEvent('baseevents:leftVehicle')
AddEventHandler('baseevents:leftVehicle', function(veh, seat)
	SetAudioSubmixEffectParamInt(heliEffectId, 0, `enabled`, 0)
end)
...
RegisterCommand('+cycleproximity', function()
	...
	MumbleSetAudioInputDistance(voiceModeData[1])
	mode = voiceMode
	...
	TriggerEvent('nadrp-hud:UpdateVoice', voiceMode)
end, false)
RegisterCommand('-cycleproximity', function()
end)
...
RegisterNetEvent('mumble:focus:set')
AddEventHandler('mumble:focus:set', function(hasFocus, hasKeyboard, hasMouse)
...
AddEventHandler('onClientResourceStart', function(resource)
	...
	TriggerEvent('nadrp-hud:UpdateVoice', mode)
end)
