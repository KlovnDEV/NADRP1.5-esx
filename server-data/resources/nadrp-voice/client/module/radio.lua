	...
	if not radioPressed then
		if radioChannel > 0 then
            ...
            Citizen.CreateThread(function()
                TriggerEvent("nadrp-voice:radioActive", true)
                ...
                if (IsEntityPlayingAnim(PlayerPedId(), "random@arrests","generic_radio_chatter", 3)) and not radioPressed then
...
RegisterCommand('-radiotalk', function()
	if radioChannel > 0 or radioEnabled and radioPressed then
		...
		playerTargets(NetworkIsPlayerTalking(PlayerId()) and callData or {})
		TriggerEvent("nadrp-voice:radioActive", false)
		playMicClicks(false)
