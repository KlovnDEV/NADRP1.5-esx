...
Config.CoreName = "tsc:getSharedObject" -- qb-core or esx:getSharedObject
Config.SkillBar = "qb-skillbar" -- Available qb-core: "qb-skillbar" | | Available ESX: "reload-skillbar" & "qb-lock"
Config.QBMenu = "qb-menu" -- Name of qb-menu
Config.Target = "bt-target" -- Target [ Only QBCore ]
...
Config.QBLock = { -- If you use Config.SkillBar = "qb-lock"
...
----------------------
Config.NeedPolice = true -- Police needed?
Config.JobPolice = "police" -- Name of job police
Config.AmountPolice = 1 -- Amount of police needed
...
----------------------
Config.WashReward = { -- Amount of ores you received after wash the stones
    Min = 2,
    Max = 4,
}
...
Config.Targets = {
    -- Mining Rocks
    CutMinerLabel = "Mine",
    CutMinerIcon = "fa-solid fa-minimize",
    -- Break Stones
    BreakStonesLabel = "Break Stones",
    BreakStonesIcon = "fa-solid fa-hand",
    -- Machine
    MachineLabel = "Save Machine",
    MachineIcon = "fa-solid fa-clock-rotate-left",
    -- Wash Stones
    SeparateMinerLabel = "Wash Stone",
    SeparateMinerIcon = "fa-solid fa-water",
    -- Shop / Boss of wood
    ShopMinerLabel = "Talk to the boss",
    ShopMinerIcon = "fa-solid fa-person",
    -- Vehicles
    VehiclesLabel = "Vehicles",
    TargetVehiclesIcon = "fa-solid fa-person",
    -- Sell ores
    SellMinerLabel = "Sell Ores",
    SellMinerIcon = "fas fa-sack-dollar",
}

-- Vehicles
Config.LocalizacaoVehicles = vector3(2957.67, 2745.84, 43.54) -- Location of vehicles

-- Sell Ores
Config.EnableBlipSell = true
Config.NameOfSellOres = "Sell Ores"     -- Name of blip
Config.TargetSellMinerLocation = vector3(-623.23, -230.23, 38.06)  -- Location of sell
...
-- Car 
----------------------
Config.PayForVehicle = true -- Pay the vehicle? [ Only available for QBCore ]
Config.AmountPayForVehicle = 250 -- Amout of the payment vehicle
...
Config.VehicleKeysTrigger = "vehiclekeys:client:SetOwner" -- Trigger to give vehiclekeys ! [ Only available for QBCore ] !
...
----------------------
-- Bag  ! [ Only available for QBCore ] !
----------------------
Config.Slots = 4
Config.Weight = 5000

-----------------
-- Shop ! [ Only available for QBCore ] !
-----------------
