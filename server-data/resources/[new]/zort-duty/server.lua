...
AddEventHandler('duty:mesaigiris', function()
    ...
    if job == 'police' or job == 'ambulance' then 
        TriggerClientEvent('mythic_notify:client:DoHudText', src, { type = 'error', text = 'Zaten mesaidesin!'})
        return
    end

    if job == 'offpolice' then
        xPlayer.setJob('police', grade)
        TriggerClientEvent('mythic_notify:client:DoHudText', src, { type = 'inform', text = 'Mesaiye girdin!'})
...
AddEventHandler('duty:mesaicikis', function()
    ...
    if job == 'offpolice' or job == 'offambulance' then 
        TriggerClientEvent('mythic_notify:client:DoHudText', src, { type = 'error', text = 'Zaten mesaide değilsin!'})
        return
    end
    ...
    if job == 'police' then
        ...
        TriggerClientEvent('mythic_notify:client:DoHudText', src, { type = 'inform', text = 'Mesaiden çıktın!'})
