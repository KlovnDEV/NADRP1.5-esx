...
AddEventHandler('RNG_CarBomb:CheckIfRequirementsAreMet', function()
    ...
    if not IsPedInAnyVehicle(ped, false) then
        if veh and (dist < 3.0) then
            ...
            if Config.DetonationType == 0 then
                if Config.UsingMythicNotifications then
                    TriggerEvent('mythic_notify:client:DoLongHudText', { type = 'error', text = _U('vanilla', Config.TimeUntilDetonation), length = 5500})
                else
            ...
            elseif Config.DetonationType == 1 then
                if Config.UsingMythicNotifications then
                    TriggerEvent('mythic_notify:client:DoLongHudText', { type = 'error', text = _U('speed', Config.maxSpeed, Config.Speed), length = 5500})
                else
            ...
            elseif Config.DetonationType == 2 then
                if Config.UsingMythicNotifications then
                    TriggerEvent('mythic_notify:client:DoLongHudText', { type = 'error', text = _U('remote'), length = 5500})
                else
            ...
            elseif Config.DetonationType == 3 then
                if Config.UsingMythicNotifications then
                    TriggerEvent('mythic_notify:client:DoLongHudText', { type = 'error', text = _U('delayed', Config.TimeUntilDetonation), length = 5500})
                else
            ...
            elseif Config.DetonationType == 4 then
                if Config.UsingMythicNotifications then
                    TriggerEvent('mythic_notify:client:DoLongHudText', { type = 'error', text = _U('instant'), length = 5500})
                else
            ...
            if Config.UsingMythicNotifications then
                TriggerEvent('mythic_notify:client:DoLongHudText', { type = 'error', text = _U('novehnearby'), length = 5500})
            else
        ...
        if Config.UsingMythicNotifications then
            TriggerEvent('mythic_notify:client:DoLongHudText', { type = 'error', text = _U('cantinside'), length = 5500})
        else
