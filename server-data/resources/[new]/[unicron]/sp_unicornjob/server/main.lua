...
AddEventHandler('esx_unicornjob:getStockItem', function(itemName, count)
  ...
  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_unicorn', function(inventory)
    ...
    TriggerClientEvent('inventory:removeItem',itemName, count)
      TriggerClientEvent('player:receiveItem',itemName, count)
...
AddEventHandler('Announceuniouv', function()
	...
	for i=1, #xPlayers, 1 do
		...
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'Unicorn', '~b~Ad Unicorn', 'Unicorn is open!', 'CHAR_ASHLEY', 8)
	end
end)
...
AddEventHandler('Announceunifer', function()
	...
	for i=1, #xPlayers, 1 do
		local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'Unicorn', '~b~Ad Unicorn', 'Unicorn is close !', 'CHAR_ASHLEY', 8)
	end
end)
    ...
    if societyAccount ~= nil and societyAccount.money >= price then
        if qtty < count then
          ...
          --  xPlayer.addInventoryItem(itemName, 1)
            TriggerClientEvent('inventory:removeItem',price)
      TriggerClientEvent('player:receiveItem',itemName, 1)
        ...
        SetTimeout(10000, function()        
            ...
            elseif bethQuantity < 2 then
                ...
                if chanceToMiss <= Config.MissCraft then
                    ...
                    TriggerClientEvent('inventory:removeItem','energy', 2)
                    TriggerClientEvent('inventory:removeItem','jager', 2)
                ...
                --    xPlayer.addInventoryItem('jagerbomb', 1)
                    TriggerClientEvent('inventory:removeItem','energy', 2)
                    TriggerClientEvent('inventory:removeItem','jager', 2)
                    TriggerClientEvent('inventory:removeItem','jagerbomb', 1)
                end
            end
    ...
    if _itemValue == 'golem' then
        SetTimeout(10000, function()        
            ...
            elseif gimelQuantity < 1 then
                ...
                if chanceToMiss <= Config.MissCraft then
                    TriggerClientEvent('esx:showNotification', _source, _U('craft_miss'))
                    TriggerClientEvent('inventory:removeItem','limonade', 2)
                    TriggerClientEvent('inventory:removeItem','vodka', 2)
                    TriggerClientEvent('inventory:removeItem','ice', 1)
               ...
               --     xPlayer.removeInventoryItem('ice', 1)
                    ...
                    TriggerClientEvent('inventory:removeItem','vodka', 2)
                    TriggerClientEvent('inventory:removeItem','ice', 1)
                    TriggerClientEvent('inventory:removeItem','golem', 1)
                   -- xPlayer.removeInventoryItem('limonade', 2)                
                  --  xPlayer.removeInventoryItem('vodka', 2)
                  --  xPlayer.removeInventoryItem('ice', 1)
          ...
          --  local bethQuantity      = xPlayer.getInventoryItem('whisky').count
            ...
            elseif bethQuantity < 2 then
                ...
                if chanceToMiss <= Config.MissCraft then
                 ...
                 xplayer =   TriggerClientEvent('inventory:removeItem',_source,'soda', 2)
                 xplayer  = TriggerClientEvent('inventory:removeItem',_source,'whisky', 2)
                    
                else
                    TriggerClientEvent('esx:showNotification', _source, _U('craft') .. _U('whiskycoca') .. ' ~w~!')
                    xplayer =   TriggerClientEvent('inventory:removeItem',_source,'soda', 2)
                    xplayer  =  TriggerClientEvent('inventory:removeItem',_source,'wisky', 2)
                    xplayer  =  TriggerClientEvent('inventory:removeItem',_source,'whiskycoca', 1)
                   -- xPlayer.removeInventoryItem('soda', 2)
                   -- xPlayer.removeInventoryItem('whisky', 2)
    ...
    if _itemValue == 'rhumcoca' then
        SetTimeout(10000, function()        
            ...
            elseif bethQuantity < 2 then
                ...
                if chanceToMiss <= Config.MissCraft then
                    TriggerClientEvent('esx:showNotification', _source, _U('craft_miss'))
                    TriggerClientEvent('inventory:removeItem','soda', 2)
                    TriggerClientEvent('inventory:removeItem','rhum', 2)
                    --xPlayer.removeInventoryItem('soda', 2)
                   -- xPlayer.removeInventoryItem('rhum', 2)
                    ...
                    TriggerClientEvent('inventory:removeItem','soda', 2)
                    TriggerClientEvent('inventory:removeItem','rhum', 2)
                    TriggerClientEvent('inventory:removeItem','rhumcoca', 1)
                  --  xPlayer.removeInventoryItem('soda', 2)
                   -- xPlayer.removeInventoryItem('rhum', 2)
