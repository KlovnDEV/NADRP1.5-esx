...
Config.Ped = {
  ...
  {label='Femme Unicorn ',type=5, hash='csb_stripper_02'},
  {label='Femme Playboy',type=5, hash='a_f_y_topless_01'},
  {label='Lisa Langery',type=5, hash='csb_stripper_01'},
  {label='Lisa Langery',type=5, hash='u_m_y_pogo_01'},
  {label='Victoria Kanayeva',type=5, hash='s_f_y_stripper_01'},
  {label='Lisa Hamilton',type=5, hash='u_m_y_zombie_01'},
}
