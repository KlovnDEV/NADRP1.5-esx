...
Config['General'] = {
    ...
    ["EmailEvent"] = "nadrp-phone:server:sendNewMail",
...
Config['CoreSettings'] = {
    ["ESX"] = {
        ["Trigger"] = "tac:getSharedObject",
        ["ProgressBarScriptName"] = "ffrp-actionbar", -- progress bar script name link in esx_readme.md
    },
    ["QBCORE"] = {
...
Config['Utils'] = {
    ...
    ["VIN"] = {
        ["BNEPrice"] = 0, -- Price (BNE) for start a vin scratch
